...
- [x] **Step 1: Add failing player-structure tests**
...
- [x] **Step 2: Restyle the player to the existing Telos v2 contract**
...
- [x] **Step 3: Add failing package-manifest tests**
...
- [x] **Step 4: Implement the zero-dependency package builder**
...
- [x] **Step 6: Commit only the scoped implementation**
...
git commit -m "feat: package verified demo media"
```
